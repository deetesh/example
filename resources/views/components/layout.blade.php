<!-- Creating components
Create layout page layout.blade.php 
Add x-layout to use the component -->
<!DOCTYPE html>
...
<html>
<!-- <nav>
    <x-new-nav-link href="/">Home</x-new-nav-link>
    <x-new-nav-link href="/about" style="color : green;">About</x-new-nav-link>
    <x-new-nav-link href="/contact">Contact</x-new-nav-link>
</nav> -->
...
<body class="h-full bg-gray-100"> 
  <div class="min-h-full">
            ...
            @auth
              <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                  <x-new-nav-link href="/" :active="request()->is('/')">Home</x-new-nav-link>
                  <x-new-nav-link href="/about" :active="request()->is('about')">About</x-new-nav-link>
                  <x-new-nav-link href="/contact" :active="request()->is('contact')">Contact Us</x-new-nav-link>
                  <x-new-nav-link href="/jobs" :active="request()->is('jobs')">Jobs</x-new-nav-link>
                </div>
              </div>
            @endauth
          </div>
    ...
    <header class="bg-white shadow-sm">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-left">
